...
def generate_progression_delete_random_memeber_return_correct_answer():
    ...
    step_of_progression = random.randint(RND_MIN_STEP_PROGRESSION,
                                         RND_MAX_STEP_PROGRESSION)
    size_of_progression = random.randint(RND_MIN_SIZE_PROGRESSION,
                                         RND_MAX_SIZE_PROGRESSION)
