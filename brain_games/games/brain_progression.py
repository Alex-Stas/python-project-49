...
from brain_games.const import QUANTITY_OF_ROUNDS, PROGRESSION_GAME_MESSAGE, \
    RND_BETWEEN_NUM1, RND_BETWEEN_NUM2, RND_MAX_STEP_PROGRESSION, \
    RND_MIN_SIZE_PROGRESSION, RND_MAX_SIZE_PROGRESSION
...
def main():
    ...
    for _ in range(QUANTITY_OF_ROUNDS):
        start_of_progression = generate_random_number(
            RND_BETWEEN_NUM1, RND_BETWEEN_NUM2)
        step_of_progression = generate_random_number(
            RND_BETWEEN_NUM1, RND_MAX_STEP_PROGRESSION)
        size_of_progression = generate_random_number(
            RND_MIN_SIZE_PROGRESSION, RND_MAX_SIZE_PROGRESSION)
        progression = generate_progression(
            start_of_progression, step_of_progression, size_of_progression)
        question, right_answer = \
            delete_random_memeber_return_modified_progression_correct_answer(
                progression)
...
def delete_random_memeber_return_modified_progression_correct_answer(
        progression):
